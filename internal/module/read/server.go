...
import (
	...
	"github.com/BMokarzel/rhaxis-code.git/internal/module/read/controller"
...
func (s *Server) Name() string         { return "read" }
func (s *Server) Addr() string         { return fmt.Sprintf(":%d", s.cfg.HTTP.ReadPort) }
